...
urlpatterns = [
    ...
    path(
        "datewise-timesheets/<int:employee_id>/<int:month>/<int:year>/",
    ...
    path(
        "datewise-performances/<int:employee_id>/<int:month>/<int:year>/",
        views.GeneralList.as_view(),
    ...
    path(
        "datewise-cashnds/<int:employee_id>/<int:month>/<int:year>/",
        views.GeneralList.as_view(),
    ...
    path(
        "datewise-payslips/<int:employee_id>/<int:month>/<int:year>/",
        views.GeneralList.as_view(),
